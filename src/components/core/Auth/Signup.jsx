    ...
    <div>
      ...
      >
        <div className="w-[450px] p-5 mt-5 rounded-md shadoww">
          <div className="pb-3">
            <h3 className="text-[#9333ea] font-bold text-2xl">Register</h3>
          </div>
          <label htmlFor="username">
            <p className="flex mb-1 text-sm text-[#9333ea]">
            ...
            <input
              ...
              className="w-full rounded-md bg-slate-50 p-[12px] text-black border  border-[#a855f7] mb-1 hover:border-[#7e22ce] focus:border-[#9333ea] select-none"
            />
          </label>
          ...
          <label htmlFor="password" className="relative">
            ...
            <input
              ...
              value={Password}
              onChange={handleOnChange}
              className="w-full  rounded-md bg-slate-50 p-[12px] text-black border  border-[#a855f7]  hover:border-[#7e22ce] focus:border-[#9333ea] select-none"
            />
          ...
          <button
            type="submit"
            className="px-5 py-2 mt-3 rounded-sm bg-[#9333ea] text-white text-sm hover:bg-[#7e22ce] 
          ...
          <div className="mt-2">
            <p>
              ...
              <Link to="/login">
                <span className="text-[#9333ea] font-bold ml-1">
                  Login here
                </span>
              </Link>
            </p>
