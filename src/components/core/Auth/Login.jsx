    ...
    <div>
        <form onSubmit={handleOnSubmit} className='flex items-center justify-center w-full px-5'>
         <div className='w-[450px] p-6 mt-5 rounded-md shadoww'>
          <div className='pb-3'>
            <h3 className='text-[#9333ea] font-bold text-2xl'>Login</h3>
          </div>
            ...
            <label htmlFor='email'>
                ...
                className='w-full rounded-md bg-slate-50 p-[12px] text-black border  border-[#a855f7] mb-2 hover:border-[#7e22ce] focus:border-[#9333ea] select-none'
                 />
            </label>
            ...
            <button 
            type='submit'
            className='px-5 py-2 mt-3 rounded-sm bg-[#9333ea] text-white text-sm
            ...
            <div className='mt-2'>
              <p>Don't have an account? 
                <Link to='/signup'>
                <span className='text-[#9333ea] font-bold ml-1'>Register Now</span>  
                </Link>
              </p>
            </div>
        </div>
